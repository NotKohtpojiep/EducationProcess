...
{
    internal sealed class EducationProcessApiPagedRequestor
    {
        private const int MaxItemsPerPage = 100;

        private readonly EducationProcessApiRequestor _requestor;

        public EducationProcessApiPagedRequestor(EducationProcessApiRequestor requestor) => _requestor = requestor;
