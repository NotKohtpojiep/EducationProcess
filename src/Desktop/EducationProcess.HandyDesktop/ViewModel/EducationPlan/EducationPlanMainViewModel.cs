    ...
    public class EducationPlanMainViewModel : ViewModelBase
    {
        ...
        public EducationPlanMainViewModel()
        {
            ...
            var tabItem = new TabItemModel
            {
                ...
                Content = AssemblyHelper.CreateInternalInstance($"UserControl.EducationPlanMenuView")
            };
        ...
        {
            var view = AssemblyHelper.CreateInternalInstance($"UserControl.EducationPlanMenuView");
