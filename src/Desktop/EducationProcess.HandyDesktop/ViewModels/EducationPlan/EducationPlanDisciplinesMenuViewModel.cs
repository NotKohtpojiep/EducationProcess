...
namespace EducationProcess.HandyDesktop.ViewModels
{
    public class EducationPlanDisciplinesMenuViewModel : ViewModelBase
    {
        ...
        public EducationPlanDisciplinesMenuViewModel(IEducationPlanSemesterDisciplineService educationPlanSemesterDisciplineService)
        {
        ...
        public string EducationPlanHeader
        {
            get => $"Дисциплины уч. плана: {_educationPlan.Name}";
        }
        ...
        public EducationPlan EducationPlanSelected
        {
            ...
            set
            {
                _educationPlan = value;
                Task.Run(() => GetAllSemesterDisciplinesByEducationPlanId(value.EducationPlanId))
