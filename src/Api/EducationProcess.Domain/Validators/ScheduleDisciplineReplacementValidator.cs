...
{
	public class ScheduleDisciplineReplacementValidator : AbstractValidator<ScheduleDisciplineReplacement>
	{
		public ScheduleDisciplineReplacementValidator()
		{
			...
			RuleFor(x => x.CreatedByEmployeeId)
				.GreaterThanOrEqualTo(0)
					.WithMessage("CreatedByEmployeeId should be greater or equal 0");
			RuleFor(x => x.FixedDisciplineId)
				.GreaterThanOrEqualTo(0)
					.WithMessage("FixedDisciplineId should be greater or equal 0");
			RuleFor(x => x.ModifiedByEmployeeId)
				.GreaterThanOrEqualTo(0)
					.WithMessage("ModifiedByEmployeeId should be greater or equal 0");
			RuleFor(x => x.ScheduleDisciplineId)
				.GreaterThanOrEqualTo(0)
					.WithMessage("ScheduleDisciplineId should be greater or equal 0");
			RuleFor(x => x.ScheduleDisciplineReplacementId)
				.GreaterThanOrEqualTo(0)
					.WithMessage("ScheduleDisciplineReplacementId should be greater or equal 0");
